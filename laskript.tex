...
\begin{bsp}
    ...
    \end{align*}
        ...
        \begin{definition}
            ...
            \begin{enumerate}[(UT)]
                \item Für jeden $R$-Moduk $L$ und jede $R$-bilineare Abbildung $\beta:M\times N\longrightarrow L$ existiert genau ein $R$-Modulhom. $f:T\longrightarrow L$, sd. $f\circ \tau=\beta$ ist.
                \[ \begin{xy}
                    \xymatrix{
                        T \ar@{-->}[rr]^{\exists!f} & & L\\
        ...
        \begin{satz}
            ...
            \begin{enumerate}[(a)]
                ...
                \item Sind $T,T'$ Tensorprodukte von $M,N$ über $R$ mit bilinearer Abbildung $\tau: M\times N\longrightarrow T,\tau':M/times N\longrightarrow T',$ dann existiert genau ein $R$-Modulisom. $\boldsymbol{\Phi}:T\longrightarrow T'$ mit $\boldsymbol{\Phi}\circ \tau =\tau'$
                \[ \begin{xy}
                    \xymatrix{
                ...
                \item ISr $T$ ein Tensorprodukt von $M,N$ über $R$ mit zugehöriger $R$-bil. Abb. $\tau:M\times N\longrightarrow T$ und sehen wir für $m\in M,n\in N$ 
                $$m\otimes n:=\tau(m,n),$$
                ...
                \item \begin{enumerate}[(1)]
                    ...
                    \begin{align*}
                        ...
                        \intertext{Die Elemente $[m,n]$ mit $m\in M, n\in N$ bilden eine Basis von $R^{(M\times N)},$ als $R$-Modul. Sei $U$ der Untermodul von $R^{(M\times N)},$ der von allen Elementen der folgenden Form erzeugt wird:}
                                ...
                                [rm,n]&-r[m,n],
                                [m,rn]&-r[m,n]\\
                        \intertext{Setze $T:= R^{(M\times N)}/U,\tau:M\times N\overset{i}{\hookrightarrow} R^{(M\times N)}\overset{\underset{\text{kan. Proj.}}{\longrightarrow}}{\pi} T=R^{(M\times N)}/U, (m,n)\longmapsto \overline[m,n].$}
                        ...
                        \begin{itemize}
                            ...
                            Es ist $g(U)=0,$ denn:
                            \begin{align*}
                                g([m+m',n]-[m,n]-[m',n])&\overline{g \text{ $R$-Modhom.}}{=}g([m+m',n])-g([m,n])-g([m'n])\\
                                &=\beta(m+m',n)-\beta(m,n)-\beta(m',n)\\
                                &\overline{\text{$\beta$ $R$-bil.}}{=}0
                            \end{align*}
        ...
        \begin{anm}
            \begin{itemize}
                ...
                \item \begin{align*}
                    ...
                    &\text{ existiert genau ein $R$-Modulhom. $f:M\otimes_R N\longrightarrow L$ mit $f(m\otimes n)\beta(m,n)$}\\
        ...
        \begin{bsp}
            \begin{align*}
            \intertext{$\Z/2\Z\oplus_{\Z}\Z/3\Z=0$}
            \intertext{denn:}
            \intertext{Für $a\in \Z/2\Z,b\in \Z/3\Z$ ist}
            a\otimes b&\underset{3\equiv 1(mod 2)}{=} (3a)\otimes b\\
            &=a\otimes (3b)\\
            &\underset{3\equiv 0(mod 3)}{=} a\otimes 0\\
            &= 0
            \end{align*}
        \end{bsp}
        \begin{bem}
        ...
        \begin{proof}
            \begin{enumerate}[1.]
                ...
                \begin{align*}
                    ...
                    &\implies x=(1+I)\otimes m= (1+I)\otimes \sum_{i=1}^{r}a_i\tilde{m_i}=\sum_{i=1}^{r}(1+I)\otimes a_im_i=\sum_{i=1}^{r}(a_i+I)\otimes m_i=\sum_{i=1}^{r}(0+I)\otimes m_i
                    &= 0
                \end{align*}
            \end{enumerate}
        \end{proof}
